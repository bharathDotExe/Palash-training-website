...
export default function InstagramBadge() {
    useEffect(() => {
        // Load the Instagram embed script if it doesn't already exist
    ...
    return (
        <div style={{ width: '100%', maxWidth: '340px', display: 'flex', justifyContent: 'center', margin: '0 auto' }}>
            <blockquote
            ...
            >
                <div style={{ padding: '16px' }}>
                    <a
                        href="https://www.instagram.com/madhuri.100369/?utm_source=ig_embed&amp;utm_campaign=loading"
                        style={{
                            background: '#FFFFFF',
                            lineHeight: '0',
                            padding: '0 0',
                    ...
                    <p style={{
                        ...
                        <a
                            ...
                            rel="noopener noreferrer"
                        >
                            Madhuri Bedekar (@madhuri.100369)
